...
============================================================
							SETUP
============================================================
Simply require and setup Ego in your main.lua file and it will work everywhere
else, so you needn't require it in each scene when using the Director class.
